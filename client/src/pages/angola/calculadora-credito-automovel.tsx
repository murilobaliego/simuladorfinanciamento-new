      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div>
              <Label htmlFor="vehicleValue" className="text-base font-semibold">Valor da Viatura (AOA)</Label>
              <Input
                id="vehicleValue"
                type="number"
                value={vehicleValue}
            ...
            <div>
              <Label htmlFor="downPayment" className="text-base font-semibold">Entrada Inicial (AOA)</Label>
              <Input
                id="downPayment"
                type="number"
                value={downPayment}
